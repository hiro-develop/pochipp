...
const UrlConfBtn = memo(({ url, hasSearchedLink }) => {
	return (
		<Button
			className='__urlConfBtn -icon-right'
...
export default ({
	...
	const amazonLink =
		amazonSearchedLink ||
		'https://www.amazon.co.jp/s?k=' + encodeURIComponent(keywords);
	...
	const yahooLink =
		yahooSearchedLink ||
		'https://shopping.yahoo.co.jp/search?p=' + encodeURIComponent(keywords);
