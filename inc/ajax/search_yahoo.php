...
function search_from_yahoo_api() {
	...
	// 検索結果を取得
	$searched_items = \POCHIPP\get_item_data_from_yahoo_api( $api_query, $keywords );
 ...
 * Yahoo APIから商品データを取得
 */
function get_item_data_from_yahoo_api( $api_query, $keywords, $itemcode = '' ) {
	...
	// OK
	return \POCHIPP\set_item_data_by_yahoo_api( $response_arr['hits'], $keywords, $itemcode );
}
 ...
 * 商品データを整形
 */
function set_item_data_by_yahoo_api( $items_data, $keywords = '', $itemcode ) {
